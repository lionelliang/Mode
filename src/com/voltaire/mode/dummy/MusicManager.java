package com.voltaire.mode.dummy;
...
public class MusicManager {
	...
	public static void start(Context context, int music, boolean force) {
		...
		if (mp != null) {
			...
			/*
			 * if (music == MUSIC_MENU) { mp = MediaPlayer.create(context,
			 * R.raw.menu_music); } else if (music == MUSIC_GAME) { mp =
			 * MediaPlayer.create(context, R.raw.game_music); } else if (music
			 * == MUSIC_END_GAME) { mp = MediaPlayer.create(context,
			 * R.raw.end_game_music); } else { Log.e(TAG,
			 * "unsupported music number - " + music); return; }
			 */
